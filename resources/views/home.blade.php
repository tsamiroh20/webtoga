        ...
        <div class="container" style="position: relative; z-index: 2;"> 
            ...
            <div class="row gy-4 d-flex justify-content-between">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    ...
                    <form class="d-flex align-items-center" action="{{ route('searchumum') }}" method="GET" style="width: 100%; overflow: hidden; background-color: #fff; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1); position: relative;">
                        <!--ikon unggah gambar-->

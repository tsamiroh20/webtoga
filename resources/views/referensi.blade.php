...
<body style="margin: 0; padding: 0; font-family: Poppins, sans-serif; background-color: #f0f0f0;">
            ...
            <div class="d-flex justify-content-center" style="width: 100%; padding: 80px 0;">
                <div class="container" data-aos="fade-up" style="max-width: 1200px;">
                    ...
                    <div class="d-flex justify-content-center mb-4">
                        <form class="d-flex" action="{{ route('referensi/search') }}" method="GET" style="width: 70%; border-radius: 50px; overflow: hidden; background-color: #fff; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
    ...
    <script>
        function reloadPage() {
            window.location.href = "/referensi"; // Atur ini ke URL yang menampilkan semua data tanaman
        }
    </script>
</body>
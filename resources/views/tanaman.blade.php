            ...
            <div class="d-flex justify-content-center" style="width: 100%; padding: 80px 0;">
                <div class="container" data-aos="fade-up" style="max-width: 1200px;">
                    ...
                    <div class="d-flex justify-content-center mb-4">
                        <form class="d-flex" action="{{ route('searchtanaman') }}" method="GET" style="width: 70%; border-radius: 50px; overflow: hidden; background-color: #fff; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
                            <input class="form-control" type="search" placeholder="Cari tanaman..." aria-label="Search" name="query" style="border: none; box-shadow: none; border-radius: 50px 0 0 50px; flex-grow: 1; padding: 10px 20px;">
                            <button class="btn btn-outline-success" type="submit" style="border: none; border-radius: 0 50px 50px 0; background-color: #28a745; color: white; padding: 10px 20px;">Cari</button>
                        </form>
                    </div>
                    ...
                    <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
                        ...
                        <div class="w-100 my-1"></div> <!-- Menambahkan garis pemisah tiap konten-->
                        @endforeach
                    </div>
